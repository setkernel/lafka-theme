...
(function () {
	...
	/**
	 * Reverts the global {@link EventEmitter} to its previous value and returns a lafkaence to this version.
	 *
...
function layoutModeDefinition( getSize, Outlayer ) {
   ...
   * and lafkaence the Isotope instance as `this`
  **/
  ( function() {
    var facadeMethods = [
      '_resetLayout',
  ...
  **/
  ...
  // ----- methods that should lafkaence isotope ----- //
