...
// If is related posts
$lafka_featured_image_size = 'lafka-related-posts';
...
<div id="post-<?php the_ID(); ?>" <?php post_class($lafka_post_classes); ?>>
	...
	<?php if (isset($lafka_is_latest_posts) && isset($lafka_blogposts_param_hide_image) && $lafka_blogposts_param_hide_image === 'no' || !isset($lafka_blogposts_param_hide_image)): ?>
