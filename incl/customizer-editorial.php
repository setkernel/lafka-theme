...
function lafka_editorial_customizer_register( WP_Customize_Manager $wp_customize ) {
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_hero_eyebrow',
        array(
			'default'           => '',
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_hero_h1_before',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_hero_h1_accent',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_hero_h1_after',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    // Hero subtitle
    $wp_customize->add_setting(
        'lafka_editorial_home_hero_subtitle',
        array(
			'default'           => '',
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_hero_image',
        array(
			'default'           => '',
    ...
    // CTA 1 (primary)
    $wp_customize->add_setting(
        'lafka_editorial_home_cta1_label',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_cta2_label',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_cta3_label',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_proof_quote',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_textarea_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_proof_stats',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_story_label',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_story_h2_before',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_story_h2_em',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_story_h2_after',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_story_pullquote',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_textarea_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_story_image',
        array(
			'default'           => '',
			'sanitize_callback' => 'esc_url_raw',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_map_embed_url',
        array(
			'default'           => '',
			'sanitize_callback' => 'esc_url_raw',
        ) 
    ...
    $wp_customize->add_section(
        'lafka_editorial_home_newsletter',
        array(
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_newsletter_heading',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_newsletter_intro',
        array(
			'default'           => '',
			'sanitize_callback' => 'sanitize_text_field',
        ) 
    ...
    $wp_customize->add_setting(
        'lafka_editorial_home_newsletter_form_html',
        array(
			'default'           => '',
    ...
    // CF7 form ID
    $wp_customize->add_setting(
        'lafka_editorial_contact_cf7_form_id',
        array(
			'default'           => 0,
			'sanitize_callback' => 'absint',
        ) 
    ...
    // Map embed URL
    $wp_customize->add_setting(
        'lafka_editorial_contact_map_embed_url',
        array(
			'default'           => '',
			'sanitize_callback' => 'esc_url_raw',
        ) 
