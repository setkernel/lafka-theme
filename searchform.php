...
<form action="<?php echo esc_url( $lafka_search_params['form_action'] ); ?>" id="searchform" method="get">
	<div>
		<label for="<?php echo esc_attr( $lafka_search_params['search_id'] ); ?>" class="screen-reader-text"><?php esc_html_e( 'Search', 'lafka' ); ?></label>
		...
		?>
		" placeholder='<?php echo esc_attr( $lafka_search_params['placeholder'] ); ?>' />
